defmodule LivescreamingWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LivescreamingWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LivescreamingWeb.Gettext, "errors", msg, opts)
    end
  end
